...
const QString BITCOIN_IPC_PREFIX("molecule:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click molecule: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start molecule: click-to-pay handler");
    else
...
{
    // clicking on molecule: URLs creates FileOpen events on the Mac:
